...
% Param.betacoe = 0.5; % beta
% Param.omegacoe = 0.5; % omega
Param.kappa = 0.99;
Param.MaxIter1 = 10000;  % Number of iterations for the algorithm
Param.MaxIter2 = 200;  % Number of iterations for the algorithm
